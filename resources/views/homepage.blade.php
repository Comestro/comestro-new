...
@section('content')
    ...
    <!-- Hero Section -->
    <section
        class="relative text-white py-[150px] pb-[100px] text-center overflow-hidden bg-gradient-to-br from-[rgba(33,37,41)] to-[rgba(33,37,41)] bg-center bg-cover hero">
        <div id="particles-js"></div>
        <div class="tech-circles"></div>
        <div class="neural-network"></div>
        <div class="container mx-auto px-5 relative z-10">
            <h1 class="text-[2.5rem] md:text-[3rem] lg:text-[3.5rem] mb-2.5 leading-tight">Innovating <span
                    class="text-[#F05A28]">Technology</span>,<br>Empowering <span class="text-[#0079C1]">People</span></h1>
            <h2 class="text-[1.3rem] md:text-[1.5rem] lg:text-[1.8rem] font-semibold mb-5 text-[#ddd]">Software Development
                | Web Solutions | IT Training</h2>
            <p class="text-base md:text-lg lg:text-xl max-w-[800px] mx-auto mb-[30px] text-[#bbb] px-4">We create
                world-class technology solutions that transform businesses and empower individuals through innovative
                software development and industry-ready training programs.</p>
            <div class="mt-[30px] flex flex-col sm:flex-row justify-center">
                <a href="#design"
                    class="inline-block py-[12px] sm:py-[15px] px-[20px] sm:px-[30px] rounded-[30px] font-semibold mx-2.5 mb-4 sm:mb-0 transition-all duration-300 hover:-translate-y-[3px] bg-[#F05A28] text-white">Get
                    Free Demo Design</a>
                <a href="#talk"
                    class="inline-block py-[12px] sm:py-[15px] px-[20px] sm:px-[30px] rounded-[30px] font-semibold mx-2.5 transition-all duration-300 hover:-translate-y-[3px] bg-transparent border-2 border-[#0079C1] text-white">Let's
                    Talk</a>
            </div>
            <div class="flex flex-wrap justify-center mt-16">
                <div class="mx-5 md:mx-10 text-center mb-6 md:mb-0">
                    <div class="text-3xl md:text-4xl font-bold text-blue-600 mb-1">
                        {{ $totalproject }}+
                    </div>
                    <div class="text-gray-300 text-base">Projects Completed</div>
                </div>
                ...
                <div class="mx-5 md:mx-10 text-center mb-6 md:mb-0">
                    ...
                    <div class="text-gray-300 text-base">Expert Developers</div>
                </div>
                ...
                <div class="mx-5 md:mx-10 text-center mb-6 md:mb-0">
                    ...
                    <div class="text-gray-300 text-base">Client Satisfaction</div>
                </div>
            </div>
    ...
    <section class="py-[100px] text-center" id="about">
        <div class="container mx-auto px-5">
            <h2 class="text-[2.5rem] mb-[50px] relative inline-block">About <span class="text-[#0079C1]">Comestro
                    Techlabs</span></h2>
            <p class="max-w-[800px] mx-auto mb-[30px] text-[1.1rem] text-[#666]">Leading the future of technology with
                innovative solutions and expert training</p>

            <div class="flex flex-col lg:flex-row justify-center gap-[30px] mt-[50px]">
                <div
                    class="bg-[#f8f9fa] rounded-[10px] p-[30px] text-left flex-1 max-w-full lg:max-w-[350px] mb-8 lg:mb-0 transition-all duration-300 hover:-translate-y-[10px]">
                    ...
                    <p class="text-[#666] leading-[1.7]">To create cutting-edge technology solutions that transform
                        businesses and empower individuals to achieve their digital aspirations through cutting-edge
                        innovative and excellence.</p>
                ...
                <div
                    class="bg-[#f8f9fa] rounded-[10px] p-[30px] text-left flex-1 max-w-full lg:max-w-[350px] transition-all duration-300 hover:-translate-y-[10px]">
                    <div class="w-[50px] h-[50px] bg-[#0079C1] rounded-[10px] flex justify-center items-center mb-5">
                        <i class="fas fa-bullseye text-white text-2xl"></i>
                    </div>
                    <h3 class="text-[1.3rem] font-semibold mb-[15px]">Our Mission</h3>
                    <p class="text-[#666] leading-[1.7]">To deliver high-quality software solutions, provide impactful
                        training programs, and foster long-term growth for our clients and students through dedication,
                        expertise, and commitment.</p>
                    <div class="flex items-center mb-2.5">
                        <i class="fas fa-check text-[#0079C1] mr-2.5"></i>
            ...
            <div class="flex flex-wrap justify-center mt-[70px] gap-x-[20px] md:gap-x-[50px] gap-y-[30px]">
                ...
                <div class="text-center w-[calc(50%-20px)] md:w-auto">
                    <div class="text-[2rem] font-bold text-[#0079C1]">{{ $totalExpertDev }}+</div>
    ...
    <section class="bg-gradient-to-b from-white to-[#f8f9fa] py-[100px] text-center" id="services">
        <div class="container mx-auto px-[10%]">
            <h2 class="text-[2.5rem] mb-[50px] relative inline-block font-bold">Our <span
                    class="text-[#0079C1]">Services</span></h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-[50px]">
                <div
                    class="bg-white rounded-[15px] p-10 text-left transition-all duration-300 hover:-translate-y-[10px] border border-gray-100">
                    ...
                    <p class="text-[#666] mb-5 leading-[1.7]">Create, implement, and maintain websites with seamless user
                        experience.</p>
                    <div class="mt-5">
                        <div class="flex items-center mb-2.5">
                            <i class="fas fa-check text-[#0079C1] mr-2.5"></i>
                    ...
                    <a href="#web-design" class="inline-block mt-5 text-[#0079C1] font-medium hover:underline">Learn
                        More</a>
                </div>
                ...
                <div
                    ...
                    <p class="text-[#666] mb-5 leading-[1.7]">Scalable and powerful mobile apps built with latest Android
                        technologies.</p>
                    <div class="mt-5">
                        <div class="flex items-center mb-2.5">
                            <i class="fas fa-check text-[#0079C1] mr-2.5"></i>
                    ...
                    <a href="#android-dev" class="inline-block mt-5 text-[#0079C1] font-medium hover:underline">Learn
                        More</a>
                </div>
                ...
                <div
                    ...
                    <p class="text-[#666] mb-5 leading-[1.7]">Cloud based solutions designed to improve your business growth
                        and efficiency.</p>
                    <div class="mt-5">
                        <div class="flex items-center mb-2.5">
                            <i class="fas fa-check text-[#0079C1] mr-2.5"></i>
                ...
                <div
                    ...
                    <p class="text-[#666] mb-5 leading-[1.7]">Launch your minimum viable product quickly for market
                        validation and rapid development.</p>
                    <div class="mt-5">
                        <div class="flex items-center mb-2.5">
                            <i class="fas fa-check text-[#0079C1] mr-2.5"></i>
                ...
                <div
                    ...
                    <p class="text-[#666] mb-5 leading-[1.7]">Experience our design expertise with a free sample before
    ...
    <section class="bg-gradient-to-br from-[#0079C1] to-[#0099CC] py-[70px] text-center text-white">
        <div class="container mx-auto px-[10%]">
            ...
            <p class="max-w-[700px] mx-auto mb-[30px]">Let's discuss your project requirements and start something amazing
                together.</p>
            <a href="#quote"
                class="inline-block bg-white text-[#0079C1] py-[15px] px-[30px] rounded-[30px] font-semibold transition-all duration-300 hover:-translate-y-[3px]">Get
                Free Quote</a>
        </div>
    </section>
    ...
    <section class="py-[100px] text-center bg-gradient-to-b from-white to-[#f8f9fa]" id="training">
        <div class="container mx-auto px-[10%]">
            <h2 class="text-[2.5rem] mb-[50px] relative inline-block font-bold">Software Engineer <span
                    class="text-[#0079C1]">Training Programs</span></h2>
            <p class="mb-8 text-lg text-gray-600">Industry-ready coding programs designed for students to excel in their
                careers</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-[50px]">
                <div
                    ...
                    <p class="text-[#666] mb-5 leading-[1.7]">Specialized programming foundation for Bachelor of Computer
                        Applications students.</p>
                    ...
                    <a href="#bca-details"
                        class="text-[#0079C1] font-medium inline-flex items-center hover:underline group">
                        View Details <i
                            class="fas fa-arrow-right ml-[5px] transition-transform duration-300 group-hover:translate-x-[5px]"></i>
                    </a>
                </div>
                ...
                <div
                    ...
                    <p class="text-[#666] mb-5 leading-[1.7]">Advanced software engineering concepts for engineering
                        students.</p>
                    <div class="flex justify-between mb-5 text-[#777] bg-gray-50 p-3 rounded-lg">
                        <span class="flex items-center"><i class="far fa-clock mr-2 text-[#0079C1]"></i> 6 Months</span>
                        <span class="flex items-center"><i class="fas fa-signal mr-2 text-[#0079C1]"></i>
                            Intermediate</span>
                    </div>
                    <a href="#btech-details"
                        class="text-[#0079C1] font-medium inline-flex items-center hover:underline group">
                        View Details <i
                            class="fas fa-arrow-right ml-[5px] transition-transform duration-300 group-hover:translate-x-[5px]"></i>
                    </a>
                ...
                <div
                    ...
                    <p class="text-[#666] mb-5 leading-[1.7]">Project management skills for Master of Computer Applications
                        students.</p>
                    <div class="flex justify-between mb-5 text-[#777] bg-gray-50 p-3 rounded-lg">
                ...
                <div
                    ...
                    <p class="text-[#666] mb-5 leading-[1.7]">Learn from experienced professionals with years of expertise.
                    </p>
                    <div class="flex justify-between mb-5 text-[#777] bg-gray-50 p-3 rounded-lg">
    ...
    <section class="bg-[#f8f9fa] py-[80px] text-center" id="journey">
        <div class="container mx-auto px-[10%]">
            <h2 class="text-[2rem] md:text-[2.5rem] mb-[30px] md:mb-[50px] relative inline-block">Ready to Start Your <span
                    class="text-[#0079C1]">Tech Journey?</span></h2>
            <p>Join thousands of students who have successfully launched their careers with our training programs.</p>
            <div class="mt-[30px] flex flex-col sm:flex-row justify-center">
                <a href="#explore"
                    class="py-3 px-6 border-2 border-[#0079C1] text-[#0079C1] rounded-[30px] font-medium mx-2.5 mb-4 sm:mb-0 transition-all duration-300 hover:bg-[#0079C1] hover:text-white inline-block">Explore
                    Training Programs</a>
                <a href="#download"
                    class="py-3 px-6 border-2 border-[#0079C1] text-[#0079C1] rounded-[30px] font-medium mx-2.5 transition-all duration-300 hover:bg-[#0079C1] hover:text-white inline-block">Download
                    Curriculum</a>
            </div>
        </div>
    </section>
