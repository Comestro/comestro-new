...
@section('content')
    ...
    <section class="page-header">
        <div class="container mx-auto px-[10%]">
            ...
            <p class="text-xl text-gray-200 max-w-3xl mx-auto">Get in touch with our team for inquiries, support, or
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div class="bg-white rounded-xl border border-gray-100 p-8">
                <h2 class="text-3xl font-bold mb-8">
                    Send us a <span class="text-[#00B7FF]">Message</span>
                </h2>
                ...
                <form action="{{ route('contact.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}"
                                ...
                                focus:outline-none focus:ring-2 focus:ring-[#00B7FF] focus:border-transparent transition">
                            @error('name')
                    ...
                    <div>
                        ...
                        <input type="text" name="subject" id="subject" value="{{ old('subject') }}"
                            ...
                            class="w-full px-4 py-3 border rounded-lg 
                            @error('subject') border-red-500 @else border-gray-300 @enderror 
                            focus:outline-none focus:ring-2 focus:ring-[#00B7FF] focus:border-transparent transition">
                        @error('subject')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <textarea name="message" id="message" rows="5"
                            ...
                            focus:outline-none focus:ring-2 focus:ring-[#00B7FF] focus:border-transparent transition">{{ old('message') }}</textarea>
                        @error('message')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        <button type="submit"
                            class="w-full py-3 px-6 bg-[#00B7FF] text-white font-semibold rounded-lg hover:bg-[#0099cc] transition duration-200 flex items-center justify-center">
    ...
    <section class="py-16 bg-gray-50">
        <div class="container mx-auto px-[10%]">
            <div class="text-center mb-12">
                ...
                <p class="text-gray-600 mt-4 max-w-3xl mx-auto">Visit us at our office located in the heart of Purnea
                    Bihar's tech hub</p>
            </div>
            ...
            <div class="bg-white rounded-xl border border-gray-100 overflow-hidden">
                <div class="aspect-w-16 aspect-h-9 h-[500px]">
                    ...
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d56042.54635794867!2d77.01201573476566!3d28.4594536!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d19d582e38859%3A0x2cf5fe8e5c64b1e!2sGurugram%2C%20Haryana!5e0!3m2!1sen!2sin!4v1690000000000!5m2!1sen!2sin"
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-[10%]">
            <div class="text-center mb-12">
                ...
                <p class="text-gray-600 mt-4 max-w-3xl mx-auto">Find answers to common questions about our services and
                    processes</p>
            </div>
            ...
            <div class="max-w-3xl mx-auto">
                ...
                <div class="mb-6">
                    <button
                        class="flex justify-between items-center w-full text-left px-6 py-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition duration-200">
                    ...
                    <div class="px-6 py-4 bg-white">
                        <p class="text-gray-600">
                            The timeline for custom software development varies based on project complexity, requirements,
                            and scope. Simple projects might take 2-3 months, while complex enterprise solutions can take
                            6-12 months. During our initial consultation, we'll provide a detailed timeline based on your
                            specific needs.
                        </p>
                    </div>
                </div>
                ...
                <div class="mb-6">
                    <button
                        class="flex justify-between items-center w-full text-left px-6 py-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition duration-200">
                        <span class="text-lg font-semibold">What training programs are available for college
                            students?</span>
                        <i class="fas fa-chevron-down text-[#00B7FF]"></i>
                    </button>
                    <div class="px-6 py-4 bg-white">
                        <p class="text-gray-600">
                            We offer specialized training programs for BCA, B.Tech, and MCA students, as well as short-term
                            courses in specific technologies. Our programs include hands-on projects, mentorship from
                            industry experts, and placement assistance. Visit our Training page for detailed information
                            about each program.
                        </p>
                    </div>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <div class="px-6 py-4 bg-white">
                        <p class="text-gray-600">
                            You can apply for open positions through our Careers page. Select the role you're interested in
                            and click the "Apply Now" button to submit your application. You can also send your resume to
                            careers@comestro.com with the job title in the subject line.
                        </p>
                    </div>
                </div>
                ...
                <div class="mb-6">
                    <button
                        class="flex justify-between items-center w-full text-left px-6 py-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition duration-200">
                        <span class="text-lg font-semibold">Do you provide maintenance and support after project
                            completion?</span>
                        <i class="fas fa-chevron-down text-[#00B7FF]"></i>
                    </button>
                    <div class="px-6 py-4 bg-white">
                        <p class="text-gray-600">
                            Yes, we offer comprehensive maintenance and support services after project completion. Our
                            support packages include regular updates, bug fixes, performance optimization, security patches,
                            and technical support. We can customize a maintenance plan based on your specific requirements.
                        </p>
                    </div>
                </div>
                ...
                <div>
                    <button
                        class="flex justify-between items-center w-full text-left px-6 py-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition duration-200">
                        <span class="text-lg font-semibold">Can you help with an existing project that needs
                            improvements?</span>
                        <i class="fas fa-chevron-down text-[#00B7FF]"></i>
                    </button>
                    <div class="px-6 py-4 bg-white">
                        <p class="text-gray-600">
                            Absolutely! We offer code review, refactoring, and enhancement services for existing projects.
                            Our team can analyze your current solution, identify areas for improvement, and implement
                            changes to enhance functionality, performance, and user experience. Contact us for a
    ...
    <section class="py-16 bg-gray-50">
        <div class="container mx-auto px-[10%]">
            <div class="text-center mb-12">
                ...
                <p class="text-gray-600 mt-4 max-w-3xl mx-auto">Choose the right department for faster response to your
                    inquiry</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-8 rounded-xl shadow-sm hover:shadow-md transition duration-300">
                    ...
                    <div class="space-y-2 text-gray-600">
                        <p class="flex items-center"><i class="fas fa-envelope mr-3 text-[#00B7FF]"></i>
                            business@comestro.com</p>
                        <p class="flex items-center"><i class="fas fa-phone-alt mr-3 text-[#00B7FF]"></i> +91 9876 543210
                        </p>
                    </div>
                </div>
                ...
                <div class="bg-white p-8 rounded-xl shadow-sm hover:shadow-md transition duration-300">
                    ...
                    <div class="space-y-2 text-gray-600">
                        <p class="flex items-center"><i class="fas fa-envelope mr-3 text-[#00B7FF]"></i>
                            support@comestro.com</p>
                        <p class="flex items-center"><i class="fas fa-phone-alt mr-3 text-[#00B7FF]"></i> +91 1234 567890
                        </p>
                    </div>
                </div>
                ...
                <div class="bg-white p-8 rounded-xl shadow-sm hover:shadow-md transition duration-300">
                    ...
                    <div class="space-y-2 text-gray-600">
                        <p class="flex items-center"><i class="fas fa-envelope mr-3 text-[#00B7FF]"></i>
                            careers@comestro.com</p>
                        <p class="flex items-center"><i class="fas fa-phone-alt mr-3 text-[#00B7FF]"></i> +91 9876 543211
                        </p>
                    </div>
                </div>
            </div>
    ...
    <section class="py-16 bg-gradient-to-r from-[#00B7FF] to-[#0099CC] text-white">
        <div class="container mx-auto px-[10%] text-center">
            ...
            <p class="text-xl mb-8 max-w-2xl mx-auto">
                Whether you need a custom software solution, website development, or training programs, we're here to help
                you succeed.
            </p>
